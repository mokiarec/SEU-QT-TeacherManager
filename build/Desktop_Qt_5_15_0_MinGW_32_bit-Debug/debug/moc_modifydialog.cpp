...
QT_MOC_LITERAL(1, 13, 14), // "Modify_success"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11) // "QModelIndex"

    },
    "ModifyDialog\0Modify_success\0\0QModelIndex"
};
...
void ModifyDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Modify_success((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ModifyDialog::*)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModifyDialog::Modify_success)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ModifyDialog::Modify_success(const QModelIndex & _t1)
{
