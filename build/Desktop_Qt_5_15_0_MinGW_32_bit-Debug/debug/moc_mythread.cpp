...
QT_MOC_LITERAL(1, 13, 8), // "sendList"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 10), // "QList<int>"
QT_MOC_LITERAL(4, 34, 4) // "list"

    },
    "FilterThread\0sendList\0\0QList<int>\0"
    "list"
};
...
void FilterThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FilterThread::*)(QList<int> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FilterThread::sendList)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FilterThread::sendList(QList<int> _t1)
{
